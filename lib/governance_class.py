...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to bpgcoind "gobject list" output
    ...
    def bpgcoind_serialise(self):
        import bpgcoinlib
        return bpgcoinlib.SHIM_serialise_for_bpgcoind(self.serialise())
